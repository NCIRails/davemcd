...
class SignupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create signup" do
    assert_difference('Signup.count') do
      post signups_url, params: { signup: { password: @signup.password, username: @signup.username } }
    end
  ...
  test "should update signup" do
    patch signup_url(@signup), params: { signup: { password: @signup.password, username: @signup.username } }
